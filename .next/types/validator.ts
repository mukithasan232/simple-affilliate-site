...
// Validate ../../src/app/api/admin/scrape/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/scrape">> = Specific
  const handler = {} as typeof import("../../src/app/api/admin/scrape/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
