...
;
;
const productsPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "src/data/products.json");
function getProducts() {
    const data = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(productsPath, "utf8");
    return JSON.parse(data);
}
function saveProducts(products) {
    __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].writeFileSync(productsPath, JSON.stringify(products, null, 4), "utf8");
}
async function GET() {
    try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__070a1b3e._.js.map